...
class _FavoriteState extends State<Favorite> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          leading: IconButton(onPressed: (){Navigator.pop(context);}, icon: Icon(Icons.arrow_back_ios,color: Colors.orange[900],)),
          title: Row(children: [Text("Favourite", style:TextStyle(color: Colors.black)), Icon(Icons.favorite, color: Colors.red,)],),
